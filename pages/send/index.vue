	...
	<view class="home">
		...
		<view class="bgc">
			...
			<view class="take">
				...
				<view class="time">
					<view class="uni-list-cell-left">期望上门时间</view>
					<!-- 选择器 -->
				...
				<view class="weight">
					<view class="uni-list-cell-left">预计重量</view>
					<!-- 选择器 -->
					<view class="uni-list-cell-db">
				...
				<view class="num">
					<view class="uni-list-cell-left">物品件数</view>
					<!-- 选择器 -->
					<view class="uni-list-cell-db">
				...
				<view class="uni-list">
					<radio-group @change="radioChange">
						<label class="uni-list-cell uni-list-cell-pd" v-for="(item, index) in items" :key="item.value">
							<view><radio :value="item.value" :checked="index === current" color="#ff3e3e" /></view>
							<view>{{ item.name }}</view>
			...
			<!-- 优惠劵 -->
			<view class="offprice" @click="tooff()"><view class="title">优惠劵</view></view>

			<view class="encrypt">
				<view class="title">信息加密</view>
				<view class="en_btn"><switch checked color="#ff3e3e" style="transform:scale(0.7)" @change="switchChange" /></view>
				<!-- switch开关 -->
			</view>
		</view>
		<!-- 底部 -->
		<view class="bottom">
			...
			<view class="b"><button class="btn" size="mini" @click="submitdata()">下单</button></view>
		</view>
		<!-- 底部end -->
