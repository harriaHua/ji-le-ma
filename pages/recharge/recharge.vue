	...
	<view class="home">
		...
		<view class="content">
			<view class="content-left">
				<view class="titleView" style="margin-left: 60rpx;margin-top: 15rpx;">
					<text class="title" decode>钱包余额</text>
				</view>
			...
			<view class="content-right">
				<image src="../../static/images/1.png" style="width: 200rpx;height: 200rpx;"></image>
			</view>
		...
		<div class="recharge-grid">
		    <div class="grid-item" v-for="(item,index) in rechargeList" :key="index"
		...
		<!-- 充值按钮 -->
		<button class="recharge-btn" @click="handleRechargeBtn">
		    充值
		</button>
