...
<template>
  <view class="content">
    ...
    <view class="swiper-content">
      <u-swiper class="swiper" :list="swiper" :indicator="true"></u-swiper
    ></view>
    ...
    <view class="menu">
      <u-grid :border="true" :col="2">
        <u-grid-item
          v-for="(menuListItem, menuListIndex) in menuList"
          :key="menuListIndex"
          @click="clickMenu"
        >
...
export default {
  ...
  data() {
    return {
      notice:
        "法律执行是法律实现的重要环节,原则是合法性、合理性、信赖保护和效率",
      baseList: [
        {
          name: "66.3",
          title: "余额",
      ...
      menuList: [
        ...
        { name: "map", mainTitle: "地址", deputyTitle: "地址管理", url: "" },
        { name: "rmb", mainTitle: "费用", deputyTitle: "快递费用", url: "" },
      ],
      swiper: [
